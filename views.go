...
func (app *appContext) InviteProxy(gc *gin.Context) {
	...
	data := gin.H{
		...
		"userExpiryRegisterMessage": app.storage.lang.User[lang].Strings.get("newAccountWillBeValidUntil"),
		"userExpiryRenewalMessage":  app.storage.lang.User[lang].Strings.get("renewalExpiryHint"),
		"passwordReset":             false,
		"customSuccessCard":         false,
